...
public class MatrixTest {
	...
	public void testCreate1WidthSame() {
		...
		int width = 1;
		int height = 4;
		Assert.assertArrayEquals(new double[][] { { 5 }, { -8.8 }, { 10 }, { 12 } },
				Matrix.create(array, width, height));
	}
	...
	public void testCreate1WidthMore() {
		...
		int width = 1;
		int height = 5;
		Assert.assertArrayEquals(new double[][] { { 5 }, { -8.8 }, { 10 }, { 12 }, { 0 } },
				Matrix.create(array, width, height));
	}
	...
	public void testCreateSame() {
		...
		int width = 2;
		int height = 3;
		Assert.assertArrayEquals(new double[][] { { 5, -8.8 }, { 10, 12 }, { -0.25, 1.2 } },
				Matrix.create(array, width, height));
	}
	...
	public void testCreateMore() {
		...
		int width = 3;
		int height = 3;
		Assert.assertArrayEquals(new double[][] { { 5, -8.8, 10 }, { 12, -0.25, 1.2 }, { 0, 0, 0 } },
				Matrix.create(array, width, height));
	}
	...
	@Test
	public void testSum() {
		double[][] matrix = { { 3.3, 4.2, -3 }, { -2, -0.5, 6.1 }, { 9 } };
	...
	public void testMainDiagonalTall() {
		double[][] matrix = { { -1.25, 3.1, 0.1, 12 }, { 2.1, 3, -2.1, 5 }, { -0.1, -0.25 }, { 3 },
				{ 1, 2, 3, 4, 5, 6 }, { -0.5, 5, 8 } };
